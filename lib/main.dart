      ...
      body: PageView(
        ...
        children: <Widget>[
          ...
          makePage(
            ...
            title: 'PC Gamer GOD OF WAR',
            description: "Excelente para entretenerse"
          ),
          makePage(
            page: 4,
            ...
            title: 'PC Gamer color rojo',
            description: "Excelente para pasar un buen rato"
          ),
        ],
      ),
    );
